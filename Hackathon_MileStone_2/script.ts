...
const resumeObjective = document.getElementById("resumeObjective") as HTMLParagraphElement;
...
function updateFormFromResume() {
    ...
    (document.getElementById("objective") as HTMLTextAreaElement).value = resumeObjective.textContent || '';
